"""
Custom completer for Prime Intellect inference API.
...
Usage:
    ...
    completer_config = PrimeIntellectCompleter.Config(
        ...
        team_id="your-team-id",  # Optional, for team accounts
    )
"""
...
class PrimeIntellectCompleter(TurnCompleter):
    """
    Turn completer for Prime Intellect inference API.

    Compatible with PaperBench's judge infrastructure.
    """
